...
NLP_FIELDNAMES = ["timestamp", "from_user_id", "to_user_id", "text_left", "text_right", "label"]


# Сохраняет пользовательское действие как пример для NLP-обучения.
def log_interaction_for_nlp(
    ...
    try:
        ...
        label = INTERACTION_LABELS.get(interaction_type, "neutral")
...
# Считает статистику собранного NLP-датасета.
